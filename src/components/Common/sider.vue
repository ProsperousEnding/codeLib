...
<template>
  <div style="height: 6vh;display: flex; align-items: center; justify-content: center;">
    ...
    <n-h1 :style="{ display: showTitle ? 'block' : 'none', 'margin-left': 2 + 'px', fontSize: 20 + 'px' }">
  ...
  <n-menu default-value="code-nav" type="primary" class="color-primary" :collapsed-width="64"
          :collapsed-icon-size="32" :icon-size="24" :options="menuOptions">
  </n-menu>
</template>
